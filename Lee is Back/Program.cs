...
//        private static float jumpTime;
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            MenuKeys = new Menu("Keys", "Keys").SetFontStyle(FontStyle.Regular, SharpDX.Color.IndianRed);
            {
                ...
                MenuKeys.AddItem(new MenuItem("Flee.Active.Ward", "Di chuyển đến khu vực")).SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)).SetFontStyle(FontStyle.Regular, SharpDX.Color.IndianRed);
                MenuKeys.AddItem(new MenuItem("Flee.Active.QW", "Tẩu thoát [Q / W]")).SetValue(new KeyBind("G".ToCharArray()[0], KeyBindType.Press)).SetFontStyle(FontStyle.Regular, SharpDX.Color.IndianRed);
                ...
                MenuKeys.AddItem(new MenuItem("Combo.WardJump", "Combo + Nhảy đến khu vực có kẻ thù")).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)).SetFontStyle(FontStyle.Regular, SharpDX.Color.Yellow);
                MenuKeys.AddItem(new MenuItem("Harass.QW", "Quấy rối: đánh với Q -> chạy với W:")).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)).SetFontStyle(FontStyle.Regular, SharpDX.Color.Aqua);
            ...
            MenuInsec = new Menu("Insec Settings", "MenuInsec").SetFontStyle(FontStyle.Regular, SharpDX.Color.Yellow);
            {
                ...
                MenuInsec.AddItem(new MenuItem("Insec.Draw", "Vẽ lại vị trí cuối")).SetValue(new Circle(true, Color.Aqua));
